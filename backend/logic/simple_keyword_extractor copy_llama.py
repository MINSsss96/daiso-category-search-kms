...
# Load environment variables (optional for local Ollama, but keeping structure)
load_dotenv()
...
def main():
    ...
    # Save to extracted_keywords_part_refill_questions_100_llama.txt
    output_txt_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "extracted_keywords_part_refill_questions_100_llama.txt")
