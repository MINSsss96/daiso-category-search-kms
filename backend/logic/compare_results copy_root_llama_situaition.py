...
KEYWORDS_FILE = os.path.join(BASE_DIR, "logic", "extracted_keywords_question_situation100_llama.txt")
OUTPUT_FILE = os.path.join(BASE_DIR, "logic", "comparison_report_question_situation100_llama.txt")
...
def main():
    ...
    with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
        ...
        for item in intentions:
            # Handle "question" and "intention" keys
