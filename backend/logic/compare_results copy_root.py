...
KEYWORDS_FILE = os.path.join(BASE_DIR, "logic", "extracted_keywords_situation100_root.txt")
OUTPUT_FILE = os.path.join(BASE_DIR, "logic", "comparison_report_situation100_root.txt")
