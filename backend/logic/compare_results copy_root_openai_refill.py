...
KEYWORDS_FILE = os.path.join(BASE_DIR, "logic", "extracted_keywords_part_refill_questions_100_openai.txt")
OUTPUT_FILE = os.path.join(BASE_DIR, "logic", "comparison_report_part_refill_questions_100_openai.txt")
