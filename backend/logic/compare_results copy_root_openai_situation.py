...
KEYWORDS_FILE = os.path.join(BASE_DIR, "logic", "extracted_keywords_question_situation100_openai.txt")
OUTPUT_FILE = os.path.join(BASE_DIR, "logic", "comparison_report_situation100_openai.txt")
