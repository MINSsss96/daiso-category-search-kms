...
# Hardcoded absolute paths to avoid ambiguity
INPUT_FILE = "c:/Users/301/dev/daiso-category-search-kms/backend/logic/comparison_report.csv"
OUTPUT_FILE = "c:/Users/301/dev/daiso-category-search-kms/backend/logic/category_breakdown_report.txt"
