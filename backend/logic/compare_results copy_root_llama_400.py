...
KEYWORDS_FILE = os.path.join(BASE_DIR, "logic", "extracted_keywords_question3_llama.txt")
OUTPUT_FILE = os.path.join(BASE_DIR, "logic", "comparison_report_question3_llama.txt")
